...
namespace UnitTests.Controllers.BookingController
{
    public class BookingControllerTests
    {
        ...
        public async Task CancelBooking_ReturnsRedirectWhenSuccessTrue()
        {
            ...
            var bookingService = new BookingService(mockBookingRepo.Object, mockSeatRepo.Object, mockValidator.Object);
        ...
        public async Task CancelBooking_Failed_ReturnsRedirectToMyBookings_WithError()
        {
            ...
            var mockValidator = new Mock<ICustomValidator<Booking>>();
            var bookingService = new BookingService(bookingRepoMock.Object, seatRepoMock.Object, mockValidator.Object);
