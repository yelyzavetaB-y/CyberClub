...
namespace UnitTests.Services
{
    public class BookingServiceTests
    {
        ...
        public async Task BookSeatAsync_ReturnsTrue_WhenSeatIsFree()
        {
            ...
            seatRepo.Setup(x => x.FindAvailableSeatAsync(zoneId, startTime, duration)).Returns(Task.FromResult(new List<Seat> { testSeat }));
            ...
            var service = new BookingService(bookingRepo.Object, seatRepo.Object);
        ...
        public async Task BookSeatAsync_ReturnsFalse_WhenSeatIsNotAvailable()
        {
            ...
            BookingService service = new BookingService(bookingRepo.Object, seatRepo.Object);
